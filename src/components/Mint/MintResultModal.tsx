...
function MintResultModal({ status, handleClick }: MintResultModalProps) {
    ...
    case 'ERROR':
      return (
        <ConfirmModal>
          ...
          <ConfirmModal.Description>You didn&apos;t have enough token.</ConfirmModal.Description>
    ...
    default:
      return (
        <ConfirmModal>
          ...
          <ConfirmModal.Description>You just minted the reputation SBT.</ConfirmModal.Description>
